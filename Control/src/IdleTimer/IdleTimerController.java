...
//		float memoryCapa = memoryMax / memoryLoad;
		float cpuUseRate = cpuLoad/cpuMax;
		float memoryUseRate = memoryLoad/memoryMax;
		diff = cpuUseRate - memoryUseRate ;
...
//		System.out.printf("%f,%f,%f,%f,%f\n", cpuUseRate,memoryUseRate,diff,preDiff,u);
